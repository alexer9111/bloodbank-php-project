...
if(mysqli_num_rows($result) > 0){
    ...
    $sql = "INSERT INTO `stafff` (`email`, `pass`) VALUES ('$email', '$password');";


    if($con->query($sql) == true){
        echo "You're Successfully Registered as Hospital Staff";
        ...
        <form action="" name="myForm" method='post'>
            <div class="log-in-container">
                ...
                <div id="log-in-button">
                    <button type="button" id="send">Sign Up Staff</button>
                </div>
