...
<body>
    <div class="index_container">
        ...
        <div class="navbar">
            ...
            <li><a href="login.php" id="login-btn">Log Out</a><img src="./image/enter.png" alt="" id="login-icon"></li>
            </ul>
        </div>
        <div class="main-body">
            ...
            <div class="left-container">
                ...
                <div class="left-container-options" id="left-container-option-first">
                    ...
                    <a href="staff.php">Blood Sample</a>
                </div>
    ...
    for (let i = 0; i < buttons.length; i++) {
      buttons[i].onclick = function() {
        ...
        alert("Sorry about this feature this will be added soon")
      };
    }
  </script>
</body>
